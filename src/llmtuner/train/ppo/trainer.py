...
from llmtuner.train.ppo.reward import reward_score
...
class CustomPPOTrainer(PPOTrainer, Trainer):
    ...
    def get_rewards(
        ...
        for i in range(len(responses)):
            ...
            prompt = self.tokenizer.decode(responses[i], skip_special_tokens=True, clean_up_tokenization_spaces=True)
            reward_list.append(torch.tensor(reward_score(prompt)))
